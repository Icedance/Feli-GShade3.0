#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\DLAA.fx"
#line 26
...
texture SLPtex {Width = 2560; Height = 1377; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 2560), (1.0 / 1377)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 2560), (1.0 / 1377)).xy);
}
#line 86
