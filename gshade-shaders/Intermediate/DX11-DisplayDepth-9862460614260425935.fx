#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\DisplayDepth.fx"
...
#line 8 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\DisplayDepth.fx"
#line 22
...
{
float3 offset = float3( float2((1.0 / 1024), (1.0 / 720)), 0.0);
...
#line 157
float grid_position = frac(dot(texcoord, ( float2(1024, 720) * float2(1.0 / 16.0, 10.0 / 36.0)) + 0.25));
#line 160
...
#line 171
float3 normal_and_depth = lerp(normal_vector, depth_value, step(1024 * 0.5, position.x));
#line 173
color = depth_value;
#line 175
if(iUIPresentType == 1)
