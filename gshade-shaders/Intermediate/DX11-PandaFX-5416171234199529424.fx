...
texture prePassLayer { Width = 2560; Height = 1377; Format = RGBA8; };
texture blurLayerHorizontal { Width = 2560 / 2; Height = 1377 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 2560 / 2; Height = 1377 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 2560 / 16; Height = 1377 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 2560 / 16; Height = 1377 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 2560 / 64; Height = 1377 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 2560 / 64; Height = 1377 / 64; Format = RGBA8; };
#line 249
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 1377 * sampling;
float divisor = 0.000001;
#line 335
