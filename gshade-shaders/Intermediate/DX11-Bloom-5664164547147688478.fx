#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Bloom.fx"
#line 4
...
#line 245 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Bloom.fx"
#line 250
...
{
#line 286
float axis =  float2((1.0 / 2560), (1.0 / 1377)).y * mult;
#line 288
for (int i = -10; i < 11; i++)
{
...
{
#line 297
float axis =  float2((1.0 / 2560), (1.0 / 1377)).x * mult;
#line 299
for (int i = -10; i < 11; i++)
{
...
{
#line 377
const float2 bps =  float2((1.0 / 2560), (1.0 / 1377)) * 2;
#line 380
...
{
#line 417
const float2 bps =  float2((1.0 / 2560), (1.0 / 1377)) * 4;
#line 423
const float2 tcP = texcoord + bps;
const float2 tcN = texcoord - bps;
...
{
#line 455
const float2 bps =  float2((1.0 / 2560), (1.0 / 1377)) * 8;
...
float2 lfcoord = 0;
float3 lenstemp = 0;
const float2 distfact = float2((texcoord.x - 0.5) *  (2560 * (1.0 / 1377)), texcoord.y - 0.5);
#line 565
...
#line 763
float2 bpsPP =  float2((1.0 / 2560), (1.0 / 1377)) * 0.5;
