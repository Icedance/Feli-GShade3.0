#line 1 "C:\FFXIV\game\gshade-shaders\Shaders\DirectionalDepthBlur.fx"
...
#line 42 "C:\FFXIV\game\gshade-shaders\Shaders\DirectionalDepthBlur.fx"
#line 44
...
#line 187
texture texDownsampledBackBuffer { Width = 2560; Height = 1440; Format = RGBA16F; };
texture texBlurDestination { Width = 2560; Height = 1440; Format = RGBA16F; };
#line 190
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 2560), (1.0 / 1440));
#line 214
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 2560), (1.0 / 1440)));
}
#line 217
...
pixelInfo.pixelDelta *= length( float2((1.0 / 2560), (1.0 / 1440)));
pixelInfo.blurLengthInPixels = length( float2(2560, 1440)) * BlurLength;
