#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\qUINT_bloom.fx"
#line 30
...
> = 4.0;
#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\qUINT_common.fxh"
#line 100
namespace qUINT
{
...
#line 113
static const float2 ASPECT_RATIO 	= float2(1.0, 2560 * (1.0 / 1377));
static const float2 PIXEL_SIZE 		= float2((1.0 / 2560), (1.0 / 1377));
static const float2 SCREEN_SIZE 	= float2(2560, 1377);
#line 119
...
#line 130 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\qUINT_bloom.fx"
#line 135
static const int BloomTex7_LowestMip =    (((1377/128 >> 1) != 0) + ((1377/128 >> 2) != 0) + ((1377/128 >> 3) != 0) + ((1377/128 >> 4) != 0) + ((1377/128 >> 5) != 0) + ((1377/128 >> 6) != 0) + ((1377/128 >> 7) != 0) + ((1377/128 >> 8) != 0) + ((1377/128 >> 9) != 0) + ((1377/128 >> 10) != 0) + ((1377/128 >> 11) != 0) + ((1377/128 >> 12) != 0) + ((1377/128 >> 13) != 0) + ((1377/128 >> 14) != 0) + ((1377/128 >> 15) != 0) + ((1377/128 >> 16) != 0));
#line 137
texture2D MXBLOOM_BloomTexSource 	{ Width = 2560/2; 	Height = 1377/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 2560/2; 	Height = 1377/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 2560/4;  	Height = 1377/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 2560/8;  	Height = 1377/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 2560/16;  Height = 1377/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 2560/32;  Height = 1377/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 2560/64;  Height = 1377/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 2560/128; Height = 1377/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
