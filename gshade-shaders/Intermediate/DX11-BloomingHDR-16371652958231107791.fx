...
texture texBC { Width = 1024 * 0.5; Height = 720 * 0.5; Format = RGBA8; MipLevels = 4;};
#line 111
sampler SamplerBC
{
Texture = texBC;
...
#line 120
texture texBlur { Width = 1024 * 0.5; Height = 720 * 0.5; Format = RGBA8; MipLevels = 3;};
#line 122
sampler SamplerBlur
{
Texture = texBlur;
...
#line 130
texture PastSingle_BackBuffer { Width = 1024; Height = 720; Format = RGBA8;};
#line 132
...
#line 182
texture PStexLumAvg {Width = 1024; Height = 720; Format = RGBA8; };
#line 184
...
{
const float2 tex_offset = 50 *  float2((1.0 / 1024), (1.0 / 720)); 
...
{
float2 tex_offset = (Spread * 0.5f) *  float2((1.0 / 1024), (1.0 / 720)); 
...
{
float2 tex_offset = (Spread * 0.25f) *  float2((1.0 / 1024), (1.0 / 720)); 
