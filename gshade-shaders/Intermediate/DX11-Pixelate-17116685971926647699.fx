...
color =  tex2D(ReShade::BackBuffer, ((pixcoord) + 0.5) *  float2((1.0 / 1920), (1.0 / 1080)));
#line 36
if(avg_amount > 0.1)
{
...
for( int x = 0 ; x < 4 ; ++x )
for( int y = 0 ; y < 4 ; ++y )
avg_color +=  tex2D(ReShade::BackBuffer, ((float2(pixcoord.x+(x*step),pixcoord.y+(y*step))) + 0.5) *  float2((1.0 / 1920), (1.0 / 1080)));
#line 45
avg_color *= 0.0625;
