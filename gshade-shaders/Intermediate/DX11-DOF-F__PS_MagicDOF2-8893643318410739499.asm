...
// V__texHDR2                        texture  float4          2d             t2      1 
// V__ReShade__BackBufferTex         texture  float4          2d             t4      1 
// V__ReShade__DepthBufferTex        texture  float4          2d             t6      1 
...
div r0.w, r0.w, r1.x
if_nz cb0[0].x
  mul r1.xy, cb0[15].xyxx, l(0.000391, 0.000694, 0.000000, 0.000000)
...
loop 
  ...
  mul r4.xy, r4.xyxx, l(0.000391, 0.000694, 0.000000, 0.000000)
  ...
  mul r3.xy, r3.xyxx, l(0.000391, 0.000694, 0.000000, 0.000000)
