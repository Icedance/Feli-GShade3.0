#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\HQ4X.fx"
#line 4
uniform float s <
ui_type = "slider";
...
#line 36 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\HQ4X.fx"
#line 38
float3 PS_HQ4X(float4 pos : SV_Position, float2 uv : TexCoord) : SV_Target
{
const float x = s * (1.0 / 2560);
const float y = s * (1.0 / 1377);
#line 43
