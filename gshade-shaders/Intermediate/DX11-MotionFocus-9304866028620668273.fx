...
#line 43
texture2D Ganossa_MF_NormTex { Width =  1024/2; Height =  720/2; Format = RGBA8; };
texture2D Ganossa_MF_PrevTex { Width =  1024/2; Height =  720/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullTex { Width =  1024/2; Height =  720/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullPrevTex { Width =  1024/2; Height =  720/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadTex { Width =  1024/2; Height =  720/2; Format = RGBA16F; };
#line 49
...
#line 93
if (!(texcoord.x <= (1.0 / 1024)*2 && texcoord.y <= (1.0 / 720)*2))
discard;
#line 96
...
#line 109
if(i <   1024/2/2 && j <   720/2/2)
quadR.x += quadFullPow;
else if(i >   1024/2/2 && j <   720/2/2)
quadR.y += quadFullPow;
else if(i <   1024/2/2 && j >   720/2/2)
quadR.z += quadFullPow;
else
...
{
float4 Ganossa_MF_Quad = saturate(tex2D(Ganossa_MF_QuadColor, float2((1.0 / 1024), (1.0 / 720)))-0.1f);
#line 126
if (mfDebug)
{
#line 129
