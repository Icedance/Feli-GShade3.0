...
mul r0.xy, r0.xyxx, l(-0.457411, 0.022820, 0.000000, 0.000000)
switch cb0[1].w
  case l(1)
  mov r0.z, l(-1.570796)
  break 
...
mul r1.x, r1.x, l(-0.859114)
sincos r0.z, null, -r0.z
mul r1.w, r0.z, l(0.462109)
mul r1.yz, r2.xxxx, l(0.000000, -0.859114, 0.462109, 0.000000)
mov r2.xz, v1.xxyx
