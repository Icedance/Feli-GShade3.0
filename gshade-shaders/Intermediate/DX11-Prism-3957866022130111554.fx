...
RadialCoord.x *=  (1920 * (1.0 / 1080));
#line 89
const float Mask = pow(2.0 * length(RadialCoord) * rsqrt( (1920 * (1.0 / 1080)) *  (1920 * (1.0 / 1080)) + 1.0), Curve);
#line 91
const float OffsetBase = Mask * Aberration * (1.0 / 1080) * 2.0;
#line 94
if(abs(OffsetBase) < (1.0 / 1080))
