#line 1 "C:\FFXIV\game\gshade-shaders\Shaders\Emboss.fx"
#line 6
...
#line 22 "C:\FFXIV\game\gshade-shaders\Shaders\Emboss.fx"
#line 24
...
const float3 col1 = tex2D(ReShade::BackBuffer, texcoord -  float2((1.0 / 2560), (1.0 / 1440))*fEmbossOffset*offset).rgb;
const float3 col3 = tex2D(ReShade::BackBuffer, texcoord +  float2((1.0 / 2560), (1.0 / 1440))*fEmbossOffset*offset).rgb;
#line 33
