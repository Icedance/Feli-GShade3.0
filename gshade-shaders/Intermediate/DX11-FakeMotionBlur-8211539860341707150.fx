...
#line 44
texture2D currTex { Width = 1024; Height = 720; Format = RGBA8; };
texture2D prevSingleTex { Width = 1024; Height = 720; Format = RGBA8; };
texture2D prevTex { Width = 1024; Height = 720; Format = RGBA8; };
#line 48
...
prev *= weight[0];
#line 64
float pixelBlur = (mbSoftness * 13 * (diff)) * ((1.0 / 1024));
float pixelBlur2 = (mbSoftness * 11 * (diff)) * ((1.0 / 720));
#line 67
[unroll]
for (int z = 1; z < 11; z++)
{
