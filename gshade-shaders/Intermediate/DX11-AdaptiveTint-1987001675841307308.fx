...
#line 12
namespace Stats {
texture2D shared_texStats { Width = 2560; Height = 1440; Format = RGBA8; MipLevels =   7.0; };
...
float fac = 0.0;
#line 422
float2 coord_pix = float2(2560, 1440) * texcoord;
...
float valN = dot(tex2D(s, texcoord + float2(0.0, - float2((1.0 / 2560), (1.0 / 1440)).y)).rgb,  float3(0.2126, 0.7151, 0.0721));
float valNE = dot(tex2D(s, texcoord + float2( float2((1.0 / 2560), (1.0 / 1440)).x, - float2((1.0 / 2560), (1.0 / 1440)).y)).rgb,  float3(0.2126, 0.7151, 0.0721));
float valE = dot(tex2D(s, texcoord + float2( float2((1.0 / 2560), (1.0 / 1440)).x, 0.0)).rgb,  float3(0.2126, 0.7151, 0.0721));
float valSE = dot(tex2D(s, texcoord + float2( float2((1.0 / 2560), (1.0 / 1440)).x,  float2((1.0 / 2560), (1.0 / 1440)).y)).rgb,  float3(0.2126, 0.7151, 0.0721));
float valS = dot(tex2D(s, texcoord + float2(0.0,  float2((1.0 / 2560), (1.0 / 1440)).y)).rgb,  float3(0.2126, 0.7151, 0.0721));
float valSW = dot(tex2D(s, texcoord + float2(- float2((1.0 / 2560), (1.0 / 1440)).x,  float2((1.0 / 2560), (1.0 / 1440)).y)).rgb,  float3(0.2126, 0.7151, 0.0721));
float valW = dot(tex2D(s, texcoord + float2(- float2((1.0 / 2560), (1.0 / 1440)).x, 0.0)).rgb,  float3(0.2126, 0.7151, 0.0721));
float valNW = dot(tex2D(s, texcoord + float2(- float2((1.0 / 2560), (1.0 / 1440)).x, - float2((1.0 / 2560), (1.0 / 1440)).y)).rgb,  float3(0.2126, 0.7151, 0.0721));
#line 486
...
float depthN =  ReShade::GetLinearizedDepth(texcoord + float2(0.0, - float2((1.0 / 2560), (1.0 / 1440)).y));
float depthNE = ReShade::GetLinearizedDepth(texcoord + float2( float2((1.0 / 2560), (1.0 / 1440)).x, - float2((1.0 / 2560), (1.0 / 1440)).y));
float depthE =  ReShade::GetLinearizedDepth(texcoord + float2( float2((1.0 / 2560), (1.0 / 1440)).x, 0.0));
float depthSE = ReShade::GetLinearizedDepth(texcoord + float2( float2((1.0 / 2560), (1.0 / 1440)).x,  float2((1.0 / 2560), (1.0 / 1440)).y));
float depthS =  ReShade::GetLinearizedDepth(texcoord + float2(0.0,  float2((1.0 / 2560), (1.0 / 1440)).y));
float depthSW = ReShade::GetLinearizedDepth(texcoord + float2(- float2((1.0 / 2560), (1.0 / 1440)).x,  float2((1.0 / 2560), (1.0 / 1440)).y));
float depthW =  ReShade::GetLinearizedDepth(texcoord + float2(- float2((1.0 / 2560), (1.0 / 1440)).x, 0.0));
float depthNW = ReShade::GetLinearizedDepth(texcoord + float2(- float2((1.0 / 2560), (1.0 / 1440)).x, - float2((1.0 / 2560), (1.0 / 1440)).y));
...
float fac = 0.0;
#line 26
float2 screencoord = float2(2560, 1440) * texcoord;
