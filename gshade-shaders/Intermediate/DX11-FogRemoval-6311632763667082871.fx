...
> = 0;
#line 320
texture ColorCorrected {Width = 2560; Height = 1377; Format = RGBA16F;};
sampler sColorCorrected {Texture = ColorCorrected;};
texture Transmission {Width = 2560; Height = 1377; Format = R8;};
...
texture FogRemoved {Width = 2560; Height = 1377; Format = RGBA16F;};
sampler sFogRemoved {Texture = FogRemoved;};
texture TruncatedPrecision {Width = 2560; Height = 1377; Format = RGBA16F;};
...
{
const int fifty = abs(0.5 *  ( (1377 /  15) *  (2560 /  15)));
const int usedMax = abs( 0.95 *  ( (1377 /  15) *  (2560 /  15)));
int4 sum =  ( (1377 /  15) *  (2560 /  15));
output = 255.0;
int i = 255;
while((sum.r <=  ( (1377 /  15) *  (2560 /  15)) || sum.g <=  ( (1377 /  15) *  (2560 /  15)) || sum.b <=  ( (1377 /  15) *  (2560 /  15)) || sum.a <=  ( (1377 /  15) *  (2560 /  15))) && i >= 0)
{
#line 383
...
if (sum.r < usedMax)
{
sum.r = 2 *  ( (1377 /  15) *  (2560 /  15));
output.r = i;
}
if (sum.g < usedMax)
{
sum.g = 2 *  ( (1377 /  15) *  (2560 /  15));
output.g = i;
}
if (sum.b < usedMax)
{
sum.b = 2 *  ( (1377 /  15) *  (2560 /  15));
output.b = i;
}
#line 404
