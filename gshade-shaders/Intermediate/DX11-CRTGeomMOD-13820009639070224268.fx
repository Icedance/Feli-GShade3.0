#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\CRTGeomMOD.fx"
...
#line 445
texture mask2x2_texture <source="mask2x2.png";> { Width = 2560 / 2; Height = 2560 / 2; Format = RGBA8; };
...
#line 452
texture BloomBlurTex { Width = 2560 / 2; Height = 1440 / 2; Format = RGBA8; };
sampler BloomBlurSampler { Texture = BloomBlurTex; };
#line 455
texture BloomBlurTex2 { Width = 2560 / 2; Height = 1440 / 2; Format = RGBA8; };
...
if (!VERTICAL_SCANLINES)
coeffs =  3.141592653589 * float4(1.0f + uv_ratio.x, uv_ratio.x, 1.0f - uv_ratio.x, 2.0f - uv_ratio.x);
else
coeffs =  3.141592653589 * float4(1.0f + uv_ratio.y, uv_ratio.y, 1.0f - uv_ratio.y, 2.0f - uv_ratio.y);
#line 1083
