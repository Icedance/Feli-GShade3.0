...
> = 0;
#line 153
texture texColorLOD { Width = 2560; Height = 1440; Format = RGBA8; MipLevels = 4; };
...
#line 239
static const float2 pxSize = float2((1.0 / 2560),(1.0 / 1440));
...
float3	ssdo = 0.0;
#line 296
const float	randomDir = tex2D(SamplerSSDONoise,frac(txCoords* float2((2560*					1.0		)/4.0,(1440*					1.0		)/4.0))).x;
