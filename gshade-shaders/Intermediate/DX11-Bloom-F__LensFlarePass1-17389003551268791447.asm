...
dcl_output o0.xyzw
dcl_temps 3
add r0.xyzw, v1.xyxy, l(0.000000, -0.018519, 0.000000, -0.016667)
...
add r1.xyzw, v1.xyxy, l(0.000000, -0.014815, 0.000000, -0.012963)
...
add r1.xyzw, v1.xyxy, l(0.000000, -0.011111, 0.000000, -0.009259)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t14.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.000000, -0.007407, 0.000000, -0.005556)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t14.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.000000, -0.003704, 0.000000, -0.001852)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t14.xyzw, s0
