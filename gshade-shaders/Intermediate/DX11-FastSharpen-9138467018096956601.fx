#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\FastSharpen.fx"
...
#line 21 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\FastSharpen.fx"
#line 23
...
> = 0.50;
#line 48
static const float2 g10 = float2( 0.3333,-1.0)* float2((1.0 / 2560), (1.0 / 1377));
static const float2 g01 = float2(-1.0,-0.3333)* float2((1.0 / 2560), (1.0 / 1377));
static const float2 g12 = float2(-0.3333, 1.0)* float2((1.0 / 2560), (1.0 / 1377));
static const float2 g21 = float2( 1.0, 0.3333)* float2((1.0 / 2560), (1.0 / 1377));
#line 53
