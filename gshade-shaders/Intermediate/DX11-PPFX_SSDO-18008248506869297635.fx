#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\PPFX_SSDO.fx"
...
#line 11 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\PPFX_SSDO.fx"
#line 34
...
> = 0;
#line 153
texture texColorLOD { Width = 2560; Height = 1377; Format = RGBA8; MipLevels = 4; };
...
#line 239
static const float2 pxSize = float2((1.0 / 2560),(1.0 / 1377));
...
float3	ssdo = 0.0;
#line 296
const float	randomDir = tex2D(SamplerSSDONoise,frac(txCoords* float2((2560*					1.0		)/4.0,(1377*					1.0		)/4.0))).x;
