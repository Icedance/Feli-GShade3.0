#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Border.fx"
...
#line 20 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Border.fx"
#line 22
...
if ( (2560 * (1.0 / 1377)) < border_ratio)
border_width_variable = float2(0.0, (1377 - (2560 / border_ratio)) * 0.5);
else
border_width_variable = float2((2560 - (1377 * border_ratio)) * 0.5, 0.0);
#line 52
const float2 border = ( float2((1.0 / 2560), (1.0 / 1377)) * border_width_variable); 
#line 54
