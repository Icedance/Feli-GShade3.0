...
> = float3(0.0, 0.0, 0.0);
#line 426
texture background_texture <source="background.png";> { Width = 1024; Height = 720; Format = RGBA8; };
sampler background_sampler { Texture = background_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 429
texture bezel_texture <source="bezel.png";> { Width = 1024; Height = 720; Format = RGBA8; };
sampler bezel_sampler { Texture = bezel_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 432
texture bezel_off_texture <source="bezel_off.png";> { Width = 1024; Height = 720; Format = RGBA8; };
sampler bezel_off_sampler { Texture = bezel_off_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 435
texture frame_texture <source="frame.png";> { Width = 1024; Height = 720; Format = RGBA8; };
sampler frame_sampler { Texture = frame_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 438
texture overlay_texture <source="overlay.png";> { Width = 1024; Height = 720; Format = RGBA8; };
...
#line 452
texture BloomBlurTex { Width = 1024 / 2; Height = 720 / 2; Format = RGBA8; };
sampler BloomBlurSampler { Texture = BloomBlurTex; };
#line 455
texture BloomBlurTex2 { Width = 1024 / 2; Height = 720 / 2; Format = RGBA8; };
