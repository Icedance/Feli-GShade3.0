...
const float3 col1 = tex2D(ReShade::BackBuffer, texcoord -  float2((1.0 / 2560), (1.0 / 1377))*fEmbossOffset*offset).rgb;
const float3 col3 = tex2D(ReShade::BackBuffer, texcoord +  float2((1.0 / 2560), (1.0 / 1377))*fEmbossOffset*offset).rgb;
#line 33
