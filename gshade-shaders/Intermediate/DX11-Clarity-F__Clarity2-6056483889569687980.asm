...
// V__ClarityTex                     texture  float4          2d             t4      1 
...
if_z cb0[0].x
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.w, r3.xyxx, t4.yzwx, s0
...
if_nz r0.y
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.y, r2.zwzz, t4.yxzw, s0
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.w, r2.zwzz, t4.yzwx, s0
...
if_nz r0.z
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.y, r2.yzyy, t4.yxzw, s0
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.w, r2.yzyy, t4.yzwx, s0
...
if_nz r0.w
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.y, r2.xyxx, t4.yxzw, s0
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.w, r2.xyxx, t4.yzwx, s0
