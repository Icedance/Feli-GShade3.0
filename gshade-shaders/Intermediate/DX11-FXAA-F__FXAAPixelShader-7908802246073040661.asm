...
ge r2.w, r1.w, r2.w
if_nz r2.w
  add r3.xyzw, v1.xyxy, l(0.000391, -0.000694, -0.000391, 0.000694)
  ...
  ge r2.w, |r2.y|, |r2.z|
  max r2.y, |r2.z|, |r2.y|
  movc r3.xyzw, r1.yyyy, l(0.000694,-0.000694,0,-0.000391), l(0.000391,-0.000391,0.000694,-0.000000)
  movc r2.z, r2.w, r3.y, r3.x
  mul_sat r1.z, r1.w, |r1.z|
  and r3.xy, r1.yyyy, l(0x39cccccd, 0x3a19999a, 0, 0)
  mad r4.xy, r2.zzzz, l(0.500000, 0.500000, 0.000000, 0.000000), v1.xyxx
  movc r1.w, r1.y, v1.x, r4.x
  movc r4.x, r1.y, r4.y, v1.y
  add r5.x, r3.w, r1.w
  movc r6.xyzw, r1.yyyy, l(-0.000000,-0.000586,0,-0.000000), l(-0.000694,-0.000000,0.001042,-0.001042)
  add r5.y, r4.x, r6.x
  add r7.x, r3.x, r1.w
  add r7.y, r3.z, r4.x
      ...
      if_nz r3.w
        ...
        if_nz r3.w
          ...
          if_nz r3.w
            ...
            and r3.z, r1.y, l(0x3acccccd)
            movc r6.xyz, r1.yyyy, l(-0.001563,0,-0.000000,0), l(-0.000000,0.002778,-0.002778,0)
            ...
            if_nz r3.w
              ...
              ge r3.xy, |r2.ywyy|, r2.xxxx
              and r1.x, r1.y, l(0x3b99999a)
              movc r6.xyz, r1.yyyy, l(-0.004688,0,-0.000000,0), l(-0.000000,0.008333,-0.008333,0)
