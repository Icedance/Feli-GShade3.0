...
// V__texDirt                        texture  float4          2d             t0      1 
// V__texSprite                      texture  float4          2d             t2      1 
// V__texBloom3                      texture  float4          2d             t8      1 
// V__texBloom5                      texture  float4          2d            t12      1 
...
if_nz r1.x
  ...
  add r2.xyzw, v1.xyxy, l(-0.000195, -0.000347, 0.000195, 0.000347)
