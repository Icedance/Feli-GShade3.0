#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\MagicBloom.fx"
...
#line 66 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\MagicBloom.fx"
#line 86
...
> = 0;
#line 223
texture tMagicBloom_1 < pooled = true; > { Width = 2560 / 2; Height = 1377 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 2560 / 4; Height = 1377 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 2560 / 8; Height = 1377 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 2560 / 16; Height = 1377 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 2560 / 32; Height = 1377 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 2560 / 64; Height = 1377 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 2560 / 128; Height = 1377 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 2560 / 256; Height = 1377 / 256; Format = RGBA16F; };
#line 232
...
#line 237
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 2560; Height = 1377; };
#line 242
...
float2 ps =  float2((1.0 / 2560), (1.0 / 1377)) * scale;
#line 276
