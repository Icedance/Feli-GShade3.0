...
#line 44
texture2D currTex { Width = 2560; Height = 1377; Format = RGBA8; };
texture2D prevSingleTex { Width = 2560; Height = 1377; Format = RGBA8; };
texture2D prevTex { Width = 2560; Height = 1377; Format = RGBA8; };
#line 48
...
float pixelBlur2 = (mbSoftness * 11 * (diff)) * ((1.0 / 1377));
#line 67
[unroll]
for (int z = 1; z < 11; z++)
{
