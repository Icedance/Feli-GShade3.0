...
// V__ClarityTex2                    texture  float4          2d             t6      1 
...
if_z cb0[0].x
  ...
  loop 
    ...
    mul r2.x, r1.w, l(0.000391)
    add r3.xy, r2.xyxx, v1.xyxx
    sample_indexable(texture2d)(float,float,float,float) r1.w, r3.xyxx, t6.yzwx, s0
    ...
    mul r2.z, r2.x, l(0.000391)
    add r2.xz, -r2.zzwz, v1.xxyx
    sample_indexable(texture2d)(float,float,float,float) r2.x, r2.xzxx, t6.xyzw, s0
...
if_nz r0.y
  ...
  loop 
    ...
    mul r1.x, r2.z, l(0.000391)
    add r2.zw, r1.xxxy, v1.xxxy
    sample_indexable(texture2d)(float,float,float,float) r1.x, r2.zwzz, t6.xyzw, s0
    ...
    mul r2.z, r2.z, cb0[0].y
    mul r1.z, r2.z, l(0.000391)
    add r2.zw, -r1.zzzw, v1.xxxy
    sample_indexable(texture2d)(float,float,float,float) r1.z, r2.zwzz, t6.yzxw, s0
...
if_nz r0.z
  ...
  loop 
    ...
    mul r1.x, r2.y, l(0.000391)
    add r2.yz, r1.xxyx, v1.xxyx
    sample_indexable(texture2d)(float,float,float,float) r1.x, r2.yzyy, t6.xyzw, s0
    ...
    mul r2.y, r2.y, cb0[0].y
    mul r1.z, r2.y, l(0.000391)
    add r2.yz, -r1.zzwz, v1.xxyx
    sample_indexable(texture2d)(float,float,float,float) r1.z, r2.yzyy, t6.yzxw, s0
...
if_nz r0.w
  ...
  loop 
    ...
    mul r2.x, r2.x, cb0[0].y
    mul r1.x, r2.x, l(0.000391)
    add r2.xy, r1.xyxx, v1.xyxx
    sample_indexable(texture2d)(float,float,float,float) r1.x, r2.xyxx, t6.xyzw, s0
    ...
    mul r2.x, r2.x, cb0[0].y
    mul r1.z, r2.x, l(0.000391)
    add r2.xy, -r1.zwzz, v1.xyxx
    sample_indexable(texture2d)(float,float,float,float) r1.z, r2.xyxx, t6.yzxw, s0
