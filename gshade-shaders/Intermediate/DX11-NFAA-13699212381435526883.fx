#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\NFAA.fx"
#line 25
...
{
float4 NFAA; 
float2 UV = texcoord.xy, SW =  float2((1.0 / 2560), (1.0 / 1377)), n; 
float t, l, r, d;
#line 77
...
{
n *=  float2((1.0 / 2560), (1.0 / 1377)) / (nl * 0.5);
#line 97
