#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Depth_Cues.fx"
#line 35
...
#line 137
texture texHB { Width = 2560  * 0.5 ; Height = 1440 * 0.5 ; Format = R8; MipLevels = 1;};
#line 139
sampler SamplerHB
{
Texture = texHB;
...
#line 144
texture texDC { Width = 2560; Height = 1440; Format = R8; MipLevels = 3;};
#line 146
sampler SamplerDC
{
Texture = texDC;
...
float W =  12 ;
#line 195
sum += BB(texcoord , + float2( float2((1.0 / 2560), (1.0 / 1440)).x * S,0) * j ) * W;
#line 197
total += W;
}
...
{
float2 S =  Spread *  1.5 * 0.75f *  float2((1.0 / 2560), (1.0 / 1440));
#line 207
