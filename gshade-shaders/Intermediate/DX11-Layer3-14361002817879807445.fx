...
> = 0;
#line 156
texture Layer3_Tex <source =  "LayerStage.png" ;> { Width = 1024; Height = 720; Format=RGBA8; };
...
const float AspectX = (1.0 - 1024 * (1.0 / 720));
const float AspectY = (1.0 - 720 * (1.0 / 1024));
const float3 mulUV = float3(texCoord.x, texCoord.y, 1);
const float2 ScaleSize = (float2( 1024,  720) * Layer3_Scale /  float2(1024, 720));
