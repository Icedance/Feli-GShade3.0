...
> = 0.75;
#line 64
texture SmoothTexture01 { Width = 1024; Height = 720; Format = RGBA8; };
sampler Texture01S { Texture = SmoothTexture01; };
#line 68
static const float2 g10 = float2( 0.333,-1.0)* float2((1.0 / 1024), (1.0 / 720));
static const float2 g01 = float2(-1.0,-0.333)* float2((1.0 / 1024), (1.0 / 720));
static const float2 g12 = float2(-0.333, 1.0)* float2((1.0 / 1024), (1.0 / 720));
static const float2 g21 = float2( 1.0, 0.333)* float2((1.0 / 1024), (1.0 / 720));
#line 73
...
#line 97
const float2 inv_size = RANGE *  float2((1.0 / 1024), (1.0 / 720));
#line 99
