#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\SimpleBloom.fx"
#line 16
...
#line 53 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\SimpleBloom.fx"
#line 55
...
const float UvOffset =  float2((1.0 / 2560), (1.0 / 1377)).x * BlurMultiplier;
Target.rgb *= Weight[0];
for (int i = 1; i < 11; i++)
{
...
#line 110
const float UvOffset =  float2((1.0 / 2560), (1.0 / 1377)).y * BlurMultiplier;
Target.rgb *= Weight[0];
for (int i = 1; i < 11; i++)
{
float SampleOffset = i * UvOffset;
