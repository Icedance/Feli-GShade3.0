...
// V__edgesTex                       texture  float4          2d             t6      1 
// V__areaTex                        texture  float4          2d            t10      1 
// V__searchTex                      texture  float4          2d            t12      1 
...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r0.w
      add r1.xyz, r1.xyzx, l(-0.000391, 0.000694, 1.000000, 0.000000)
  ...
  loop 
    breakc_z r0.w
    add r2.xyz, r2.xyzx, l(0.000391, -0.000694, 1.000000, 0.000000)
  ...
  if_nz r0.w
    ...
    mad r2.xyzw, r1.yxzw, l(0.000391, 0.000694, 0.000391, 0.000694), v1.xyxy
  ...
  if_nz r1.z
    ...
    loop 
      breakc_z r2.y
      add r4.xyz, r4.xyzx, l(0.000391, 0.000694, 1.000000, 0.000000)
  ...
  if_nz r0.y
    mad r4.xyzw, r2.zzxx, l(-0.000391, -0.000694, 0.000391, 0.000694), v1.xyxy
  ...
  if_nz r0.y
    ...
    loop 
      ...
      add r2.xy, r2.xyxx, l(-0.000781, -0.000000, 0.000000, 0.000000)
      lt r1.w, v4.x, r2.x
      ...
      and r1.z, r1.w, r2.z
    endloop 
    mad r0.yz, r0.zzwz, l(0.000000, 0.500000, -2.000000, 0.000000), l(0.000000, 0.007813, 2.031250, 0.000000)
    sample_l_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t12.yxzw, s2, r0.z
    mad r0.y, r0.y, l(-2.007874), l(3.250000)
    mad r2.x, r0.y, l(0.000391), r2.x
    mov r2.y, v3.y
    ...
    loop 
      ...
      add r3.xy, r3.xyxx, l(0.000781, 0.000000, 0.000000, 0.000000)
      lt r3.w, r3.x, v4.y
    ...
    mad r2.z, r0.w, l(-0.000391), r3.x
    mad r1.zw, r2.zzzx, l(0.000000, 0.000000, 2560.000000, 2560.000000), -v1.zzzz
...
if_nz r0.x
  ...
  loop 
    ...
    and r0.w, r1.w, r1.z
  endloop 
  mad r0.xy, r0.yzyy, l(0.500000, -2.000000, 0.000000, 0.000000), l(0.007813, 2.031250, 0.000000, 0.000000)
