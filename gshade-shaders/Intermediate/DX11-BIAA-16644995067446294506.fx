#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\BIAA.fx"
#line 20
...
const float2 Offset =  float2((1.0 / 2560), (1.0 / 1377));
const float2 X = float2( float2((1.0 / 2560), (1.0 / 1377)).x, 0.0), Y = float2(0.0,  float2((1.0 / 2560), (1.0 / 1377)).y);
#line 94
