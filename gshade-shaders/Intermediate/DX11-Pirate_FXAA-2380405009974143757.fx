#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Pirate_FXAA.fx"
...
#line 2 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Pirate_FXAA.fx"
#line 5
...
#line 41
for(int i=0; i < 8; i++) {
ret = tex2D(ReShade::BackBuffer, coord + tap[i] *  float2((1.0 / 2560), (1.0 / 1377)) * FXAA_RADIUS);
