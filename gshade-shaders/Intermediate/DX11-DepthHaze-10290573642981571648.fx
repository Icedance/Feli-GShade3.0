#line 1 "C:\FFXIV\game\gshade-shaders\Shaders\DepthHaze.fx"
#line 15
...
#line 35 "C:\FFXIV\game\gshade-shaders\Shaders\DepthHaze.fx"
#line 40
texture   Otis_FragmentBuffer1 	{ Width = 2560; Height = 1440; Format = RGBA8;};
texture   Otis_FragmentBuffer2 	< pooled = true; > { Width = 2560; Height = 1440; Format = RGBA8;};
#line 46
...
for(float i = 1; i < 5; ++i)
{
float2 sourceCoords = texcoord + float2(i *  float2((1.0 / 2560), (1.0 / 1440)).x, 0.0);
...
n+=weight;
#line 71
sourceCoords = texcoord - float2(i *  float2((1.0 / 2560), (1.0 / 1440)).x, 0.0);
...
for(float j = 1; j < 5; ++j)
{
float2 sourceCoords = texcoord + float2(0.0, j *  float2((1.0 / 2560), (1.0 / 1440)).y);
...
n+=weight;
#line 93
sourceCoords = texcoord - float2(0.0, j *  float2((1.0 / 2560), (1.0 / 1440)).y);
