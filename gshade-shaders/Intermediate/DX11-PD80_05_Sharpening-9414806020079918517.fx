...
> = 1.0;
#line 112
texture texGaussianH { Width = 2560; Height = 1377; };
texture texGaussian { Width = 2560; Height = 1377; };
#line 116
...
float loops      = max( 2560, 1377 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 2560, 1377 ) / 1920.0f ); 
