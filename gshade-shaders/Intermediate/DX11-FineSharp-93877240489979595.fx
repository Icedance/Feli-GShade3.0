#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\FineSharp.fx"
#line 17
uniform float sstr <
ui_type = "slider";
...
#line 58 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\FineSharp.fx"
#line 62
float4 Src(float a, float b, float2 tex) {
return tex2D(ReShade::BackBuffer, mad( float2((1.0 / 2560), (1.0 / 1377)), float2(a, b), tex));
}
#line 66
...
return sign(t) * (sstr / 255.0) * pow(abs(t) / (abs(lstr / 255.0)), 1.0 / pstr) * ((t * t) / mad(t, t,  (sstr+0.1)	 / 65025.0));
}
#line 160
