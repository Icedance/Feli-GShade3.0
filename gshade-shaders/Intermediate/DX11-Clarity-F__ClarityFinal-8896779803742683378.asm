...
// V__ClarityTex3                    texture  float4          2d             t8      1 
...
if_z cb0[0].x
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.w, r3.xyxx, t8.yzwx, s0
    ...
    sample_indexable(texture2d)(float,float,float,float) r2.y, r2.ywyy, t8.yxzw, s0
...
if_nz r0.y
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.y, r2.zwzz, t8.yxzw, s0
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.w, r2.zwzz, t8.yzwx, s0
...
if_nz r0.z
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.y, r2.yzyy, t8.yxzw, s0
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.w, r2.yzyy, t8.yzwx, s0
...
if_nz r0.w
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.y, r2.xyxx, t8.yxzw, s0
    ...
    sample_indexable(texture2d)(float,float,float,float) r1.w, r2.xyxx, t8.yzwx, s0
