...
#line 187
texture texDownsampledBackBuffer { Width = 2560; Height = 1377; Format = RGBA16F; };
texture texBlurDestination { Width = 2560; Height = 1377; Format = RGBA16F; };
#line 190
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 2560), (1.0 / 1377));
#line 214
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 2560), (1.0 / 1377)));
}
#line 217
...
pixelInfo.pixelDelta *= length( float2((1.0 / 2560), (1.0 / 1377)));
pixelInfo.blurLengthInPixels = length( float2(2560, 1377)) * BlurLength;
