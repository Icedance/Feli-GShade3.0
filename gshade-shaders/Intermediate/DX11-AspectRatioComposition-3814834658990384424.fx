...
#line 64
if(aspectRatio <  (2560 * (1.0 / 1377)))
{
borderSize = (2560 - 1377 * aspectRatio) / 2.0;
fractionWidth = (2560 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (2560 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (1377 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (1377 - 2560 / aspectRatio) / 2.0;
fractionWidth = (1377 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (1377 - borderSize))
retVal = gridColor;
#line 86
...
#line 94
if(vpos.x <= 1 || vpos.x >= 2560-1 || vpos.y <= 1 || vpos.y >= 1377-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(2560, 1377, 0, 0) - vpos);
}
#line 125
