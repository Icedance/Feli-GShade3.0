...
RadialCoord.x *=  (2560 * (1.0 / 1377));
#line 89
const float Mask = pow(2.0 * length(RadialCoord) * rsqrt( (2560 * (1.0 / 1377)) *  (2560 * (1.0 / 1377)) + 1.0), Curve);
#line 91
const float OffsetBase = Mask * Aberration * (1.0 / 1377) * 2.0;
#line 94
if(abs(OffsetBase) < (1.0 / 1377))
