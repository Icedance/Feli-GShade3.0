#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Emphasize.fx"
#line 10
...
#line 61 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Emphasize.fx"
#line 67
...
if(Spherical == true)
{
texcoord.x = (texcoord.x-Sphere_FocusHorizontal)*2560;
texcoord.y = (texcoord.y-Sphere_FocusVertical)*1377;
const float degreePerPixel = Sphere_FieldOfView*(1.0 / 2560);
