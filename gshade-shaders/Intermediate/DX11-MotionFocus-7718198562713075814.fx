...
#line 43
texture2D Ganossa_MF_NormTex { Width =  2560/2; Height =  1377/2; Format = RGBA8; };
texture2D Ganossa_MF_PrevTex { Width =  2560/2; Height =  1377/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullTex { Width =  2560/2; Height =  1377/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullPrevTex { Width =  2560/2; Height =  1377/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadTex { Width =  2560/2; Height =  1377/2; Format = RGBA16F; };
#line 49
...
#line 93
if (!(texcoord.x <= (1.0 / 2560)*2 && texcoord.y <= (1.0 / 1377)*2))
discard;
#line 96
...
#line 102
[unroll]
for (float j = 2.0f; j <  1377/2; j=j+ 1377/108f )
{
coord.y = (1.0 / 1377)*j*2;
float3 quadFull = tex2D(Ganossa_MF_QuadFullColor, coord).xyz;
float quadFullPow = quadFull.x+quadFull.y+quadFull.z;
#line 109
if(i <   2560/2/2 && j <   1377/2/2)
quadR.x += quadFullPow;
else if(i >   2560/2/2 && j <   1377/2/2)
quadR.y += quadFullPow;
else if(i <   2560/2/2 && j >   1377/2/2)
quadR.z += quadFullPow;
else
...
{
float4 Ganossa_MF_Quad = saturate(tex2D(Ganossa_MF_QuadColor, float2((1.0 / 2560), (1.0 / 1377)))-0.1f);
#line 126
if (mfDebug)
{
#line 129
