#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\HotsamplingHelper.fx"
...
#line 43 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\HotsamplingHelper.fx"
#line 45
...
#line 61
const float2 overlayPos = fUIOverlayPos * (1.0 - fUIOverlayScale) *  float2(2560, 1440);
#line 63
if(all(vpos.xy >= overlayPos) && all(vpos.xy < overlayPos +  float2(2560, 1440) * fUIOverlayScale))
{
texcoord = frac((texcoord - overlayPos /  float2(2560, 1440)) / fUIOverlayScale);
}
#line 68
