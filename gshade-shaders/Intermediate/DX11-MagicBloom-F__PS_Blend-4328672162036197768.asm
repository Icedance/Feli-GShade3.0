...
//   float fExposure;                   // Offset:   12 Size:     4
...
// V__tMagicBloom_1                  texture  float4          2d             t4      1 
// V__tMagicBloom_2                  texture  float4          2d             t6      1 
// V__tMagicBloom_3                  texture  float4          2d             t8      1 
// V__tMagicBloom_4                  texture  float4          2d            t10      1 
// V__tMagicBloom_5                  texture  float4          2d            t12      1 
// V__tMagicBloom_6                  texture  float4          2d            t14      1 
// V__tMagicBloom_7                  texture  float4          2d            t16      1 
// V__tMagicBloom_8                  texture  float4          2d            t18      1 
// V__tMagicBloom_Adapt              texture  float4          2d            t22      1 
// V__tMagicBloom_Dirt               texture  float4          2d            t26      1 
