...
{
const float tileSize = 			1			 * (float(1920) / float(	1920.0f));
float minCoC = 10;
float coc;
...
{
float tileSize = 			1			 * (float( float2(1920, 1080).y) / float(	1200.0f));
float minCoC = 10;
float coc;
...
{
float minCoC = 10;
const float tileSizeX = 			1			 * (float( float2(1920, 1080).x) / float(	1920.0f));
const float tileSizeY = 			1			 * (float( float2(1920, 1080).y) / float(	1200.0f));
#line 497
