#line 1 "C:\FFXIV\game\gshade-shaders\Shaders\ColorIsolation.fx"
...
#line 38 "C:\FFXIV\game\gshade-shaders\Shaders\ColorIsolation.fx"
#line 43
...
#line 180
const float2 overlayPos = pos * ( float2(2560, 1440) - size);
#line 182
if(all(vpos.xy >= overlayPos) && all(vpos.xy < overlayPos + size))
{
x = Map(texcoord.x, float2(overlayPos.x, overlayPos.x + size.x) / 2560, float2(0.0, 1.0));
