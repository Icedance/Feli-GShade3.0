...
// V__texDistance                    texture  float4          2d             t6      1 
// V__texSurfaceNormal               texture  float4          2d             t8      1 
...
if_nz cb0[1].y
  ...
  loop 
    ...
    loop 
      breakc_z r5.z
      mad r7.xy, r5.xyxx, l(0.001367, 0.002431, 0.000000, 0.000000), v1.xyxx
...
loop 
  ...
  mul r6.zw, r6.xxxy, l(0.000000, 0.000000, 1.000000, 1.777778)
  itof r5.w, r4.w
  add r7.x, r0.w, r5.w
