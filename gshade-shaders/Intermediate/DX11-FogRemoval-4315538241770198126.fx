...
> = 0;
#line 320
texture ColorCorrected {Width = 1024; Height = 720; Format = RGBA16F;};
sampler sColorCorrected {Texture = ColorCorrected;};
texture Transmission {Width = 1024; Height = 720; Format = R8;};
...
texture FogRemoved {Width = 1024; Height = 720; Format = RGBA16F;};
sampler sFogRemoved {Texture = FogRemoved;};
texture TruncatedPrecision {Width = 1024; Height = 720; Format = RGBA16F;};
...
const int4 texturePos = int4((uint(id / 4) %  (1024 /  15)) *  15, (uint(id / 4) /  (1024 /  15)) *  15, 0, 0);
float color;
float y;
#line 342
switch (iteration)
...
{
const int fifty = abs(0.5 *  ( (720 /  15) *  (1024 /  15)));
const int usedMax = abs( 0.95 *  ( (720 /  15) *  (1024 /  15)));
int4 sum =  ( (720 /  15) *  (1024 /  15));
output = 255.0;
int i = 255;
while((sum.r <=  ( (720 /  15) *  (1024 /  15)) || sum.g <=  ( (720 /  15) *  (1024 /  15)) || sum.b <=  ( (720 /  15) *  (1024 /  15)) || sum.a <=  ( (720 /  15) *  (1024 /  15))) && i >= 0)
{
#line 383
...
if (sum.r < usedMax)
{
sum.r = 2 *  ( (720 /  15) *  (1024 /  15));
output.r = i;
}
if (sum.g < usedMax)
{
sum.g = 2 *  ( (720 /  15) *  (1024 /  15));
output.g = i;
}
if (sum.b < usedMax)
{
sum.b = 2 *  ( (720 /  15) *  (1024 /  15));
output.b = i;
}
#line 404
