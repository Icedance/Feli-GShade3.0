...
#line 187
texture texDownsampledBackBuffer { Width = 1024; Height = 720; Format = RGBA16F; };
texture texBlurDestination { Width = 1024; Height = 720; Format = RGBA16F; };
#line 190
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 1024), (1.0 / 720));
#line 214
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 1024), (1.0 / 720)));
}
#line 217
...
pixelInfo.pixelDelta *= length( float2((1.0 / 1024), (1.0 / 720)));
pixelInfo.blurLengthInPixels = length( float2(1024, 720)) * BlurLength;
