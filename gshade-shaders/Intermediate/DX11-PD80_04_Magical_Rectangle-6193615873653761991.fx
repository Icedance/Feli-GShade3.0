...
static const float2 dither_uv = float2( 1024, 720 ) / 512.0f;
#line 69
...
> = 1.0;
#line 217
texture texMagicRectangle { Width = 1024; Height = 720; Format = RGBA16F; };
#line 220
...
uv.y         = ( id == 1 ) ? 2.0 : 0.0;
uv.xy        -= center.xy;
uv.y         /=  float( 1024 * (1.0 / 720) );
float dim    = ceil( sqrt( 1024 * 1024 + 720 * 720 )); 
float maxlen = min( 1024, 720 );
dim          = dim / maxlen; 
uv.xy        /= dim;
