#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\ASCII.fx"
...
#line 48 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\ASCII.fx"
#line 55
...
const float2 cursor_position = trunc(( float2(2560, 1377) / Ascii_block) * tex) * (Ascii_block /  float2(2560, 1377));
#line 208
const float2 cp15 = cursor_position +  float2((1.0 / 2560), (1.0 / 1377)) * 1.5;
const float2 cp35 = cursor_position +  float2((1.0 / 2560), (1.0 / 1377)) * 3.5;
const float2 cp55 = cursor_position +  float2((1.0 / 2560), (1.0 / 1377)) * 5.5;
#line 212
...
#line 249
const float2 p = trunc(frac(( float2(2560, 1377) / Ascii_block) * tex) * Ascii_block); 
#line 251
