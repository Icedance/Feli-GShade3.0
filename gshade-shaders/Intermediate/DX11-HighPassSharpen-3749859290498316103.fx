#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\HighPassSharpen.fx"
#line 7
...
#line 63 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\HighPassSharpen.fx"
#line 65
...
[loop]
for(int i = 1; i < 5; ++i) {
color += tex2D(ReShade::BackBuffer, texcoord + float2(sampleOffsetsX[i] * (1.0 / 2560), sampleOffsetsY[i] * (1.0 / 1377)) * HighPassSharpOffset).rgb * sampleWeights[i];
color += tex2D(ReShade::BackBuffer, texcoord - float2(sampleOffsetsX[i] * (1.0 / 2560), sampleOffsetsY[i] * (1.0 / 1377)) * HighPassSharpOffset).rgb * sampleWeights[i];
}
}
#line 88
