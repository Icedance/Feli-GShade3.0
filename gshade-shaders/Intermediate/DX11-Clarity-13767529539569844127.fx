...
for(int i = 1; i < 4; ++i)
{
color += tex2D(ClaritySampler3, texcoord + float2(0.0, offset[i] *  float2((1.0 / 1920), (1.0 / 1080)).y) * ClarityOffset).r * weight[i];
color += tex2D(ClaritySampler3, texcoord - float2(0.0, offset[i] *  float2((1.0 / 1920), (1.0 / 1080)).y) * ClarityOffset).r * weight[i];
}
}
#line 107
...
for(int i = 1; i < 4; ++i)
{
color += tex2D(ReShade::BackBuffer, texcoord + float2(offset[i] *  float2((1.0 / 1920), (1.0 / 1080)).x, 0.0) * ClarityOffset).rgb * weight[i];
color += tex2D(ReShade::BackBuffer, texcoord - float2(offset[i] *  float2((1.0 / 1920), (1.0 / 1080)).x, 0.0) * ClarityOffset).rgb * weight[i];
}
}
#line 283
...
for(int i = 1; i < 4; ++i)
{
color += tex2D(ClaritySampler, texcoord + float2(0.0, offset[i] *  float2((1.0 / 1920), (1.0 / 1080)).y) * ClarityOffset).r* weight[i];
color += tex2D(ClaritySampler, texcoord - float2(0.0, offset[i] *  float2((1.0 / 1920), (1.0 / 1080)).y) * ClarityOffset).r* weight[i];
}
}
#line 365
...
for(int i = 1; i < 4; ++i)
{
color += tex2D(ClaritySampler2, texcoord + float2(offset[i] *  float2((1.0 / 1920), (1.0 / 1080)).x, 0.0) * ClarityOffset).r* weight[i];
color += tex2D(ClaritySampler2, texcoord - float2(offset[i] *  float2((1.0 / 1920), (1.0 / 1080)).x, 0.0) * ClarityOffset).r* weight[i];
}
}
#line 447
