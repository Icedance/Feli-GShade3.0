...
#line 113
static const float2 ASPECT_RATIO 	= float2(1.0, 1024 * (1.0 / 720));
static const float2 PIXEL_SIZE 		= float2((1.0 / 1024), (1.0 / 720));
static const float2 SCREEN_SIZE 	= float2(1024, 720);
#line 119
...
#line 137
texture2D MXBLOOM_BloomTexSource 	{ Width = 1024/2; 	Height = 720/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 1024/2; 	Height = 720/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 1024/4;  	Height = 720/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 1024/8;  	Height = 720/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 1024/16;  Height = 720/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 1024/32;  Height = 720/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 1024/64;  Height = 720/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 1024/128; Height = 720/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
