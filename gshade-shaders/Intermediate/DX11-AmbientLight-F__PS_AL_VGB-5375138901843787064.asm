...
// V__alOutTex                       texture  float4          2d             t6      1 
...
add r0.xyzw, v1.yxyy, l(0.028291, 0.000000, 0.028291, -0.028291)
...
add r2.xyzw, v1.xyyy, l(-0.000000, -0.028291, 0.050519, -0.050519)
...
add r3.xyzw, v1.xyxy, l(0.000000, 0.050519, -0.000000, -0.050519)
...
add r2.xyzw, v1.yxyy, l(0.072748, 0.000000, 0.072748, -0.072748)
...
add r2.xyzw, v1.xyyy, l(-0.000000, -0.072748, 0.094976, -0.094976)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t6.xyzw, s0
mul r3.xyzw, r0.zzzz, r3.xyzw
mad r3.xyzw, r3.xyzw, l(0.024068, 0.024068, 0.024068, 0.024068), r1.xyzw
movc r1.xyzw, r0.yyyy, r3.xyzw, r1.xyzw
add r3.xyzw, v1.xyxy, l(0.000000, 0.094976, -0.000000, -0.094976)
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r3.xyxx, t6.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r3.zwzz, t6.xyzw, s0
mul r3.xyzw, r0.zzzz, r3.xyzw
