...
if_z cb0[0].x
  ...
  loop 
    ...
    mul r2.w, r2.w, cb0[0].y
    mul r3.z, r2.w, l(0.000391)
    add r3.xz, -r3.zzwz, v1.xxyx
    sample_indexable(texture2d)(float,float,float,float) r5.xyz, r3.xzxx, t0.xyzw, s0
...
if_nz r1.y
  ...
  loop 
    ...
    sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xzxx, t0.xyzw, s0
