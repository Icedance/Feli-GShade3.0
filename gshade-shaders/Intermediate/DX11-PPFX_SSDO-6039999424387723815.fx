...
> = 0;
#line 153
texture texColorLOD { Width = 1024; Height = 720; Format = RGBA8; MipLevels = 4; };
...
#line 239
static const float2 pxSize = float2((1.0 / 1024),(1.0 / 720));
...
float3	ssdo = 0.0;
#line 296
const float	randomDir = tex2D(SamplerSSDONoise,frac(txCoords* float2((1024*					1.0		)/4.0,(720*					1.0		)/4.0))).x;
