#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\MatCap.fx"
...
#line 2 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\MatCap.fx"
#line 10
...
static const float2 offset = float2((1.0 / 2560), 0.0); 
return (get_depth(uv + offset) - get_depth(uv - offset)) * 2560 * 0.5;
}
#line 33
float get_depth_ddy(float2 uv) {
static const float2 offset = float2(0.0, (1.0 / 1377)); 
return (get_depth(uv - offset) - get_depth(uv + offset)) * 1377 * 0.5;
}
#line 38
