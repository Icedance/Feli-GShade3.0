#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Nostalgia.fx"
...
#line 51 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Nostalgia.fx"
#line 65
...
{
#line 545
const float grid_position = frac(dot(texcoord,  float2(2560, 1377) * 0.5) + 0.25); 
#line 548
...
{
color *= frac(texcoord.y * (1377 * 0.5)) + 0.5; 
}
if (Nostalgia_scanlines == 2)
{
float grey  = dot(color,float(1.0/3.0));
if (frac(texcoord.y * (1377 * 0.5)) >= 0.25);
