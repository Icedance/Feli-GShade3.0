...
#line 61
const float2 overlayPos = fUIOverlayPos * (1.0 - fUIOverlayScale) *  float2(1024, 720);
#line 63
if(all(vpos.xy >= overlayPos) && all(vpos.xy < overlayPos +  float2(1024, 720) * fUIOverlayScale))
{
texcoord = frac((texcoord - overlayPos /  float2(1024, 720)) / fUIOverlayScale);
}
#line 68
