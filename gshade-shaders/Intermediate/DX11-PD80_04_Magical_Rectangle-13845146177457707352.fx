...
> = 1.0;
#line 217
texture texMagicRectangle { Width = 2560; Height = 1377; Format = RGBA16F; };
#line 220
...
uv.y         = ( id == 1 ) ? 2.0 : 0.0;
uv.xy        -= center.xy;
uv.y         /=  float( 2560 * (1.0 / 1377) );
float dim    = ceil( sqrt( 2560 * 2560 + 1377 * 1377 )); 
float maxlen = min( 2560, 1377 );
dim          = dim / maxlen; 
uv.xy        /= dim;
