#line 1 "C:\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\dh_anime.fx"
...
> = 16;
#line 58
texture normalTex { Width = 2560; Height = 1440; };
sampler normalSampler { Texture = normalTex; };
#line 61
texture blurTex { Width = 2560; Height = 1440; };
...
const float2 searchCoords = coords+ float2((1.0 / 2560), (1.0 / 1440))*delta;
